...
public class PsController {
	...
	StoryDTO story4 = new StoryDTO("메인이벤트 1", "마녀를 만나서 잡히게 된 당신, 당신의 선택은?", "[1] 마녀를 제압하려 하지만 이긴다는 보장은 없다",
			...
			"[3] 마녀에게 풀어주면 가지고 있는 모든 돈을 준다고 한다. 하지만 돈을 준다고 해도 풀어준다는 보장은 없다",
			"[4] 마녀와 대화를 하고 자신이 살아야 하는 수많은 이유를 말하며 설득하려 하지만 풀어줄 보장은 없다.");
	...
	StoryDTO story12 = new StoryDTO("메인이벤트 3",
			"\r\n" + "\r\n" + "마녀에게서 탈출한 당신은 한가지 물약을 먹을 수 있게 된다면 먹을 물약은?, 당신에게 한가지 초능력이 생기게 되는데 당신이 선택할 초능력은?",
